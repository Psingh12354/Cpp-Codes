// Program to check the limits
#include<iostream>
#include<climits>
using namespace std;
int main(){
	cout<<" Check the upper limit and lower limits of integers"<<endl;
	cout<<"- - - -- - -- - - - -- - -- - -- "<<endl;
	cout<<"Maximum limit of int data  :         "<<INT_MAX<<endl;
	cout<<"Lower limit of int data  :            "<<INT_MIN<<endl;
